...
public class FileController {
	...
	public ResponseEntity<Resource> downloadFile(@PathVariable(value = "filename") String filename,
		...
		if (contentType.isBlank()) contentType = "application/octet-stream"; /*https://docs.spring.io/spring-cloud-stream/docs/Brooklyn.RELEASE/reference/html/contenttypemanagement.html*/
